...
namespace MqTool
{
    internal class Program
    {
        ...
        {
            string mtMessage1 = @"{1:F01ESSESES0AXXX8000019102}{2:O1030955100518CIBCCATTAXXX7676396079" + DateTime.Now.ToString("yyMMddHHmm") + @"N}{3:{103:}{108:WA SQ9E3P}{119:}{111:001}{121:2e66e52d-5448-4742-875a-c39a844bbdc2}}{4:
:20:GEcG
:23B:CRED
...
2/TRANSVERSAL 93 53 48 INT 70	4/19920914
3/CO/BOGOTA
:71A:SHA
:72:/REC/RETN
-}{S:{MAN:UAKOUAK4600}}";
            string mtMessage2 = @"{1:F01ESSESES0AXXX8000025977}{2:O1030955100518IRVTUS3NAXXX7676396079" + DateTime.Now.ToString("yyMMddHHmm") + @"N}{3:{108:78}{121:E01EBC0C-0B22-322A-A8F1-097839E991F4}}{4:
:20:RS202102158
:23B:CRED
:32A:210215SEK12,00
:33B:SEK12,00
