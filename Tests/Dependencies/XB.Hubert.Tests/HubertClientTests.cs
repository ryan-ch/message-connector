...
namespace XB.Hubert.Tests
{
    public class HubertClientTests
    {
        ...
        public HubertClientTests()
        {
            ...
            var hubertClientOptions = new HubertClientOptions { Url = "https://dummyurl.se" };
            ...
            mockHttpMessageHandler.Protected()
                ...
                {
                    Content = new StringContent(JsonConvert.SerializeObject(new CrossbordpmtUpdate01Fcpsts01Response
                    {
            ...
            var httpClientMock = new Mock<HttpClient>(mockHttpMessageHandler.Object);
